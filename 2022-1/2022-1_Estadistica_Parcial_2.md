...
| **18 abril.**                      | **Fecha límite para entregas.**                                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| **Clase 1:**                                                                        | **Clase 2:**                                                                                                                           |
| ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| 1. Comenzar **Práctica 05**.<br>    1. Equipos.                                     | 1. Continuación y revisión **Práctica 05.**<br>2. Explicar errores cuadrados y overfitting con: https://rpsychologist.com/correlation/ |
| **Preguntas tema 5:**<br><br>1. Puntajes Z y estandarizados, ¿para qué se utilizan? | Pendientes de revisar videolecciones:<br><br>1. Naomi Betancourt.<br>2. Luis Bogarin.<br>3. Jorge Enriquez.<br>4. Lizeth García.       |
...
----------
# 2️⃣ S07 (07-11 marzo) - 6 Probabilidad


1. En esta semana ya se espera que hayas leído el **Capítulo 6 (Probabilidad)** antes de llegar a la clase. No olvides contestar el Cuestionario de este capítulo también antes de llegar a clase.
2. Lo más relevante de esta semana es que comencemos a **utilizar números para asignar probabilidades a eventos**. Además de identificar que hay varias maneras de comentar sobre probabilidad de algo, especialmente con las **probabilidades condicionales**.

| **Clase 1:**                                                                                                                                                                                                                                                                                                                                                                                                                                             | **Clase 2:**                                                                            |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| 1. Revisar status de **Práctica 05**.<br>    1. Revisar respuestas.<br>    2. Puntajez Z y estandarizados. **<br>2. **Cambiemos calificación del portafolio:**<br>    1. Se calificará cada práctica con la misma rúbrica. 90%<br>    2. No “resolver” comentarios. Se usarán para la calificación de cada práctica.<br>    3. Se calificará la entrega de portafolio como eso: sólo la entrega. 10%<br>3. Comenzar **Práctica 06**.<br>    1. Equipos.  | 1. Continuación y revisión **Práctica 06.**<br>2. Noticias encontradas por cada equipo. |
| **Preguntas tema 6:**<br><br>1. Representación Bayesiana.<br>2. Probabilidades infección con vacuna COVID-19.<br>3. Reglas de probabilidad.<br><br>**Práctica 05:**<br><br>- Equipo 1:<br>- Equipo 2:<br>- Equipo 3:<br>- Equipo 4:<br>- Equipo 5:<br>- Equipo 6:<br>- Equipo 7:<br>- Equipo 8:<br>    - <br><br>Áreas de oportunidad en prácticas:<br><br>- Lizeth. Organizar archivos.<br>- Adrián. Redacción de cierres.<br>- Heylin. <br>- Isabella. |                                                                                         |



## Material complementario:
1. CrashCourse tiene unos videos muy buenos sobre las bases de la probabilidad:
    1. [Part1](https://www.youtube.com/watch?v=OyddY7DlV58): Rules and patterns.
    2. [Part2](https://www.youtube.com/watch?v=oZCskBpHWyk&t=1s): Updating your beliefs with Bayes.
    3. [Randomness](https://www.youtube.com/watch?v=jL9en6NvQfk).
2. CrashCourse tiene un video de 12 mins muy bueno como introducción a la probabilidad, incluyendo la mención de la probabilidad condicional en exámenes médicos: [YouTube](https://www.youtube.com/watch?v=OyddY7DlV58&ab_channel=CrashCourse).
3. CrashCourse y la distribución binomial (éxito/fracaso): [YouTube](https://www.youtube.com/watch?v=WR0nMTr6uOo&list=PLH2l6uzC4UEW3iJO4T0qUeUEp_X-f1U7S&index=16).
4. Otro video de CrashCourse hace un excelente análisis de la Regla de Bayes para invertir probabilidades condicionales: [YouTube](https://www.youtube.com/watch?v=oZCskBpHWyk&ab_channel=CrashCourse).
5. CrashCourse y azar: [YouTube](https://www.youtube.com/watch?v=jL9en6NvQfk&list=PLH2l6uzC4UEW3iJO4T0qUeUEp_X-f1U7S&index=18).


----------
# 3️⃣ S08 (14-18 marzo) - 7 Muestro, y 8 Re-muestreo y simulación
